...
public class UserOrderServiceImpl implements UserOrderService {
	...
	public JsonResult<WalletInfoVo> getMyWalletInfo(PageVo pageVo) throws Exception {
		...
		JSONObject fUser = null;
		Map<Long,JSONObject> userPassportMap = new HashMap<Long, JSONObject>();
        for (UserAccountList userAccountList : list) {
        	accountListVo = new AccountListVo();
        	accountListVo.setAcountTypeStr(Const.AccountType.getMsgByCode(userAccountList.getAcountType()));
        	...
        	if(fUser != null){
        		accountListVo.setPartnerName(fUser.getString("nickName"));
        	}
