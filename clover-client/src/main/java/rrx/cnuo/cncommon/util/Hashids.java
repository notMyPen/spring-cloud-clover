...
public class Hashids {
     ...
     */
    public String encode(long... numbers) throws Exception {
        if (numbers.length == 0) {
            return "";
        }
     ...
     */
    public long[] decode(String hash) throws Exception {
        if (hash.isEmpty()) {
            return new long[0];
        }
     ...
     * @return the encoded string
     */
    public String encodeHex(String hexa) throws Exception {
     ...
     * @return decoded numbers
     */
    public String decodeHex(String hash) throws Exception {
    ...
    public static int checkedCast(long value) throws Exception {
    ...
    private String _encode(long... numbers) throws Exception {
    ...
    private long[] _decode(String hash, String alphabet) throws Exception {
    ...
    private static String consistentShuffle(String alphabet, String salt) throws Exception {
        if (salt.length() <= 0) {
            return alphabet;
        }
    ...
    private static String hash(long input, String alphabet) throws Exception {
        String hash = "";
    ...
    private static Long unhash(String input, String alphabet) throws Exception {
        long number = 0, pos;
