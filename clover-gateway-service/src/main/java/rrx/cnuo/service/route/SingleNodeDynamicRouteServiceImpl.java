package rrx.cnuo.service.route;
 ...
 */
@Service
public class SingleNodeDynamicRouteServiceImpl implements ApplicationEventPublisherAware {

    @Autowired
    private RouteDefinitionWriter routeDefinitionWriter;//该接口的实现默认是InMemoryRouteDefinitionRepository（是保存在当前实例的内存中的，无法做到整个集群动态路由）
