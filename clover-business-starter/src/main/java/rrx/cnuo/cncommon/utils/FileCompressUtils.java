...
public class FileCompressUtils {
	...
	public static final int MAX_IMAGE_SIZE = 5; //图片的最大size（M）
	public static final int MAX_VIDEO_SIZE = 10; //图片的最大size（M）
...
//    private static final float COMPRESS_QUALITY = 0.4f;
     ...
     * @return
     */
    public static boolean checkImageOutSize(Long len) {
    	double fileSize = (double) len / 1048576;//兆-M
     ...
     * @return
     */
    public static boolean checkVideoOutSize(Long len) {
    	double fileSize = (double) len / 1048576;//兆-M
